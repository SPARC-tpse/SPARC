      ...
      <section v-if="tab === 'new'" class="space-y-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div class="mb-4">
            ...
            <div class="flex gap-2">
              <input
                v-model="newDisruption.start"
                type="datetime-local"
                class="input"
              />
              <button type="button" @click="setNow('start')" class="bg-blue-500 text-white px-3 rounded hover:bg-blue-600">Now</button>
            </div>
          </div>
          ...
          <div class="mb-4">
            ...
            <div class="flex gap-2">
              <input
                v-model="newDisruption.end"
                type="datetime-local"
                class="input"
              />
              <button type="button" @click="setNow('end')" class="bg-blue-500 text-white px-3 rounded hover:bg-blue-600">Now</button>
            </div>
          </div>
