      ...
      <div class="flex flex-wrap items-center justify-between gap-4">
        ...
        <div class="flex gap-2">
          <button @click="toggleDeleteMode"
            :class="isDeleteMode ? theme.btnDeleteModeActive : theme.btnDeleteMode"
          >
            {{ isDeleteMode ? 'Done' : 'Delete mode' }}
          </button>
          <NuxtLink to="/order/new" :class="theme.btnNewEntity">+ New Order</NuxtLink>
        </div>
      </div>
      ...
      <div class="grid gap-2 overflow-x-auto">
        ...
        >
          <div class="font-medium flex items-center gap-2 overflow-hidden min-w-0">
            ...
            <button v-if="deleteConfirmId === order.id" @click.stop="executeDelete(order.id)" :class="theme.btnConfirmDelete">Confirm</button>
          ...
          <div class="text-right">
            <button @click.stop="handleRowAction(order.id)"
              :class="isDeleteMode ? theme.btnActionDelete : theme.btnAction"
            >
